...
\label{subsec:ownership_transfer}
...
Each system which we have examined contain unique features that are not found in
others.

, for example: multiple ownership, ownership
