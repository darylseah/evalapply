...
\begin{itemize}
    ...
    \item \textbf{The owner-as-dominator discipline is lost}. This admits more
        ...
        restricted to one dominator.

    \item \textbf{Ownership constraints reflect the implementation} of ownership
        in the form of sets. Their semantics are difficult to reason about
        without understanding of the view of ownership contexts as sets, and may
        not be as easy to use as other type systems.

    \item \textbf{Multiple ownership has not been fully generalised}, seeing as
        it is work in a new direction. Notably, work on integrating it with
        generics and race detection is ongoing.
