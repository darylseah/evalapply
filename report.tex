...
objects that the type has co-ownership for. Read access is granted due to the
\textbf{owners-as-modifiers} discipline.
...
Only SafeJava and Multiple Ownership describes effect specifications as part of
the system. Effect specifications are useful because they allow analysis tools
to make assumptions about the program that is being analysed, increasing the
accuracy of the analyses.

%TODO needs more work.

\subsubsection{Alias Control}
\label{subsubsec:benefits_alias_control}
